...
<form action="${pageContext.request.contextPath}/teach/findCourseTypeByCD.action" method="post">
...
<form action="${pageContext.request.contextPath}/teach/findCourseType.action" method="post">
    ...
    <table width="97%" border="1">
        ...
        <s:iterator value="#pageBean.data" var="course">
            <tr class="tabtd1">
                ...
                <td width="11%" align="center">
                    <a href="${pageContext.request.contextPath}/teach/findSingleCourseType.action?courseTypeId=${course.courseTypeId}">
