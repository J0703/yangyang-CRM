...
<table width="100%" border="1">
    ...
    <tr class="tabtd1">
        ...
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/pages/refer/showRefer.jsp"><img
        ...
        <!-- 编辑 -->
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/pages/refer/editRefer.jsp"><img
                    src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
        </td>

        <!-- 添加跟踪 -->
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/pages/follow/addOrEditFollow.jsp"><img
    ...
    <tr class="tabtd2">
        ...
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/refer/referAction_findById.action?referId=2c9091c14c79506c014c7981cf370000"><img
                    src="${pageContext.request.contextPath}/images/button/view.gif" class="img"/></a>
        </td>
        ...
        <!-- 编辑 -->
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/refer/referAction_preEdit.action?referId=2c9091c14c79506c014c7981cf370000"><img
                    src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
        </td>

        <!-- 添加跟踪 -->
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/follow/followAction_preAddOrEdit.action?crmRefer.referId=2c9091c14c79506c014c7981cf370000"><img
                    src="${pageContext.request.contextPath}/images/button/new.gif" class="img"/></a>
        </td>

        <!-- 入学 -->
        <td width="8%" align="center">
            <a href="${pageContext.request.contextPath}/refer/referAction_preAddStudent.action?referId=2c9091c14c79506c014c7981cf370000"><img
                    src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
        </td>
